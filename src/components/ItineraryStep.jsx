        ...
        Tokyo: [
          {
            ...
            category: "Luxury",
            description:
              "Modern luxury hotel in the heart of Shibuya with panoramic city views",
          },
          {
            name: "Tokyo Bay Marriott",
            priceRange: "$200-350/night",
            category: "Mid-range",
            description:
              "Business hotel with excellent amenities near Tokyo Bay",
          },
          {
            name: "Capsule Inn Akihabara",
            priceRange: "$30-60/night",
            category: "Budget",
            description:
              "Futuristic capsule hotel experience in electronics district",
          },
          {
          ...
          },
          {
            ...
            category: "Mid-range",
            description: "Traditional Japanese inn with tatami rooms and onsen",
          },
          {
            ...
            category: "Budget",
            description:
              "Stylish hostel in Asakusa with modern design and social spaces",
          },
          {
            ...
            category: "Luxury",
            description:
              "Classic Japanese hospitality with elegant traditional design",
          },
        ],
        Kyoto: [
          {
            ...
            category: "Luxury",
            description: "Exclusive luxury ryokan in historic Gion district",
          },
          {
            name: "Hotel Granvia Kyoto",
            priceRange: "$180-280/night",
            category: "Mid-range",
            description: "Convenient hotel connected to Kyoto Station",
          },
          {
            name: "K's House Kyoto",
            priceRange: "$20-40/night",
            category: "Budget",
            description:
              "Backpacker hostel with traditional Japanese atmosphere",
          },
          {
            name: "Kikunoya Ryokan",
            priceRange: "$400-600/night",
            category: "Luxury",
            description:
              "Historic ryokan with centuries of tradition and kaiseki dining",
          },
          {
            ...
            category: "Mid-range",
            description:
              "Boutique hotel near Imperial Palace with Japanese gardens",
          },
          {
            name: "Piece Hostel Sanjo",
            priceRange: "$30-55/night",
            category: "Budget",
            description: "Modern hostel in downtown Kyoto with rooftop terrace",
          },
          {
            ...
            category: "Luxury",
            description:
              "Ultra-luxury hotel with river views and world-class spa",
          },
        ],
        Osaka: [
          {
            ...
            priceRange: "$400-600/night",
            category: "Luxury",
            description: "Sophisticated luxury hotel in Midosuji district",
          },
          {
            name: "Hotel Keihan Universal City",
            priceRange: "$120-200/night",
            category: "Mid-range",
            description: "Family-friendly hotel near Universal Studios Japan",
          },
          {
            name: "Hostel 64 Osaka",
            priceRange: "$25-45/night",
            category: "Budget",
            description: "Stylish hostel in trendy Sumiyoshi area",
          },
          {
            name: "Conrad Osaka",
            priceRange: "$350-550/night",
            category: "Luxury",
            description: "Modern luxury hotel with stunning city and bay views",
          },
          {
            name: "Dormy Inn Osaka",
            priceRange: "$100-160/night",
            category: "Mid-range",
            description:
              "Business hotel with rooftop onsen and free ramen service",
          },
          {
            name: "J-Hoppers Osaka Guesthouse",
            priceRange: "$20-35/night",
            category: "Budget",
            description: "Cozy guesthouse near Osaka Castle",
          },
          {
            ...
            category: "Luxury",
            description:
              "Premium hotel directly connected to Nankai Namba Station",
          },
        ],
      };
      ...
      const defaultHotels = [
        {
          ...
          priceRange: "$200-350/night",
          category: "Luxury",
          description: "Premier luxury accommodation in the city center",
        },
        {
          name: `${cityName} Business Inn`,
          priceRange: "$80-120/night",
          category: "Mid-range",
          description: "Comfortable business hotel with modern amenities",
        },
        {
          name: `${cityName} Backpackers`,
          priceRange: "$25-40/night",
          category: "Budget",
          description: "Affordable hostel for budget travelers",
        },
        {
          name: `${cityName} Resort`,
          priceRange: "$300-500/night",
          category: "Luxury",
          description: "Upscale resort with spa and fine dining",
        },
        {
          name: `${cityName} Station Hotel`,
          priceRange: "$100-150/night",
          category: "Mid-range",
          description: "Convenient hotel near main train station",
        },
        {
          name: `${cityName} Guesthouse`,
        ...
        },
        {
          ...
          priceRange: "$400-600/night",
          category: "Luxury",
          description: "Exclusive luxury suites with personalized service",
        },
      ];
